...
* 
* Parsely.js:
* This is a javascript library that manages client side data validation.
* It is used to improve the user experience.
* Validation on the server side is still necessary.
*/
