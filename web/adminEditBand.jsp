                   ...
                   <div class="row">
                    ...
                    <div class="col-lg-12 well">
                        <div class="row">
                           ...
                           <form id="editBandForm" data-parsley-validate="" action="EditBandServlet" method="POST">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <!--INSERT INTO BAND(BANDNAME, GENRE, EMAIL, CANCELLED, IMG_NAME, DESCRIPTION, TWITTER_URL)-->
                                            <label><%= Strings_Eng.STR_BAND_NAME%></label>
                                            <input type="text" placeholder="Enter Band Name Here.." class="form-control" name="bandname"
                                                   ...
                                                   value = "${sessionScope.SKTHISBAND.getBandname()}">
                                        </div>
                                    </div> 
                                    <div class="row">
                                        <div class="col-lg-12 form-group">
                                            <label><%= Strings_Eng.STR_GENRE%></label>
                                            <input type="text" placeholder="Enter Genre Here.." class="form-control" name="genre"
                                                   data-parsley-required="true" data-parsley-maxlength="15"
                                                   value = "${sessionScope.SKTHISBAND.getGenre()}">
                                        </div>
                                    </div>  
                                    ...
                                    <div class="col-lg-12 form-group">
                                        ...
                                        <input type="text" placeholder="Enter Email Address Here.." class="form-control" name="email"
                                              ...
                                              value ="${sessionScope.SKTHISBAND.getEmail()}">
                                    </div> 
                                    </div>
                                    
                                    <div class="row">
                                        <div class="col-lg-12 form-group">
                                            <label><%= Strings_Eng.STR_DESCRIPTION%></label>
                                            <textarea rows = "7" placeholder="Enter Description Here.." class="form-control" name="description"
                                                     ...
                                                     >${sessionScope.SKTHISBAND.getDescription()}</textarea>
                                        </div> 
                                    </div>  
                                    <div class="row">
                                        <div class="col-lg-12 form-group">
                                            <label><%= Strings_Eng.STR_TWITTER_DATA%></label>
                                            <input type="text" placeholder="Enter Twitter Data-Widget-ID Here.." class="form-control" name="dataWidgetID"
                                                    data-parsley-maxlength="20" 
                                                   value = "${sessionScope.SKTHISBAND.getTwitterUrl()}">
                                        </div> 
                                    </div>  
                                    <input type="submit" class="btn btn-default text-center" value="Submit"/>
                                        ...
                                        <div class ="col-lg-6">
                                            <a href="#">
                                                  <img class="img-responsive" src="images/${sessionScope.SKTHISBAND.getImgName()}" alt="">
                                                 </a>
                                                 <p>Image uploads are not supported in this version.</p>
                                        </div>
                        </div>
                    </div>
