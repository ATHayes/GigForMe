...
/**
 * Prepares the Edit Band Page for viewing
 * @author anthonyhayes
 */
public class ServeEditBandPage extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher rd = request.getRequestDispatcher(IConstants.EDIT_BAND_PAGE);
